...
public class YAMLFixtures {
    private static final String fixtureYaml = "fixture_1: \n"
            + "  id: 1\n"
    ...
    public static Map<String, Object> parseYaml() {
        Yaml yaml = new Yaml();
        return (Map<String, Object>) yaml.load(fixtureYaml);
    }


    public static void main(String[] args) {

        Map<String, Object> foo = parseYaml();
